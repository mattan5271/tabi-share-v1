...
# 利用シーン
Scene.create(name: 'デート', image: open('./app/assets/images/scenes/デート.jpg'))
Scene.create(name: '一人旅', image: open('./app/assets/images/scenes/一人旅.jpg'))
Scene.create(name: '家族旅行', image: open('./app/assets/images/scenes/家族旅行.jpg'))
Scene.create(name: 'ドライブ', image: open('./app/assets/images/scenes/ドライブ.jpg'))
...
parent = Genre.create(name: 'テーマパーク・レジャーランド', image: open('./app/assets/images/genres/テーマパーク.jpg'))
...
parent = Genre.create(name: '動物園・水族館', image: open('./app/assets/images/genres/動物園・水族館.jpg'))
...
parent = Genre.create(name: '景観', image: open('./app/assets/images/genres/景観.jpg'))
...
parent = Genre.create(name: '社寺', image: open('./app/assets/images/genres/社寺.jpg'))
...
parent = Genre.create(name: '温泉', image: open('./app/assets/images/genres/温泉.jpg'))
...
parent = Genre.create(name: '公園・庭園', image: open('./app/assets/images/genres/公園・庭園.jpg'))
...
parent = Genre.create(name: 'アウトドア', image: open('./app/assets/images/genres/アウトドア.jpg'))
...
parent = Genre.create(name: 'ショッピング', image: open('./app/assets/images/genres/ショッピング.jpg'))
...
parent = Genre.create(name: 'その他', image: open('./app/assets/images/genres/その他.jpg'))
